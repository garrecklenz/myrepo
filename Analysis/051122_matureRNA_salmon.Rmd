...
txi_salmon_mat <- tximport(mat_files, type = "salmon", tx2gene = tx2gene, ignoreTxVersion = FALSE)
```
...
plotCounts(dd_salmon_mat, gene="Hsa-Mir-4424_3p", intgroup="condition")
plotCounts(dd_salmon_mat, gene="Hsa-Mir-191_5p", intgroup="condition")Hsa-Mir-3942_5p
